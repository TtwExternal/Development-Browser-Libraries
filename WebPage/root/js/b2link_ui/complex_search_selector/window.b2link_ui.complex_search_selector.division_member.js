//----------------------------------------------------------------------------------------------------;
//var fileNm = "js/b2link_ui/complex_search_selector/window.b2link_ui.complex_search_selector.division_member.js";
...
(function(){
	...
	{
		//window.TtwLog.timeStamp( "---- [ S ] - window.b2link_ui.complex_search_selector.division_member():{void}----------" );
		...
		//window.TtwLog.timeStamp( "---- [ E ] - window.b2link_ui.complex_search_selector.division_member():{void}----------" );
	};
	_._cb0;
	_._elC0;
	_._elC1;
