//----------------------------------------------------------------------------------------------------;
//var fileNm = "js/b2link_ui/complex_search_selector/window.b2link_ui.complex_search_selector.partner_buyer__company_type_company__person.js";
...
(function(){
	...
	{
		//window.TtwLog.timeStamp( "---- [ S ] - window.b2link_ui.complex_search_selector.partner_buyer__company_type_company__person():{void}----------" );
		...
		//window.TtwLog.timeStamp( "---- [ E ] - window.b2link_ui.complex_search_selector.partner_buyer__company_type_company__person():{void}----------" );
	};
	_._cb0;
	_._elC0;
	_._elC1;
