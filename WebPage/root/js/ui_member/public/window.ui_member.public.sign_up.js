//----------------------------------------------------------------------------------------------------;
//var fileNm = "js/ui_member/window.ui_member.public.sign_up.js";
...
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_member.public.sign_up():{Array}----------" );
...
//	}
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.ui_member.public.sign_up():{Array}----------" );
	return o;
};
