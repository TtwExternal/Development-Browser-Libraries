//----------------------------------------------------------------------------------------------------;
//var fileNm = "js/ui_member/window.ui_member.common.sign_in.js";
...
{
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_member.common.sign_in():{Array}----------" );
	...
	{
		window.TtwLog.timeStamp( "---- [ E ] - window.ui_member.common.sign_in():{Array}----------if( elC.evt_Complete__SignIn )" );
		return o;
	}

	elC.evt_Complete__SignIn = window.ui_member.common.sign_in._evt_Complete__SignIn;

	window.TtwLog.timeStamp( "---- [ E ] - window.ui_member.common.sign_in():{Array}----------return o;" );
	return o;
};
