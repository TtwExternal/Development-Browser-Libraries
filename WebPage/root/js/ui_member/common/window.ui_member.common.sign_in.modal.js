//----------------------------------------------------------------------------------------------------;
//var fileNm = "js/ui_member/window.ui_member.common.sign_in.modal.js";
...
window.ui_member.common.sign_in.modal = function()
{
	...
	window.TtwLog.timeStamp( "---- [ S ] - window.ui_member.common.sign_in.modal():{Array}----------" );
	...
	{
		window.TtwLog.timeStamp( "---- [ E ] - window.ui_member.common.sign_in.modal():{Array}----------if( elC.evt_Complete__SignIn )" );
		return o;
	}

	elC.evt_Complete__SignIn = window.ui_member.common.sign_in._evt_Complete__SignIn;

	window.TtwLog.timeStamp( "---- [ E ] - window.ui_member.common.sign_in.modal():{Array}----------" );
