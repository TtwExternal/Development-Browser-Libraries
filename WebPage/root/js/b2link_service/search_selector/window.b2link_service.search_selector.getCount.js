//----------------------------------------------------------------------------------------------------;
//var fileNm = "js/b2link_service/search_selector/window.b2link_service.search_selector.getCount.js";
...
{
	//window.TtwLog.timeStamp( "---- [ S ] -window.b2link_service.search_selector.getCount():void----------" );
	...
	//window.TtwLog.timeStamp( "---- [ E ] - window.b2link_service.search_selector.getCount():void----------" );
};
