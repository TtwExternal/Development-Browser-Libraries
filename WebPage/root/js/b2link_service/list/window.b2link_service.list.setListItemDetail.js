//----------------------------------------------------------------------------------------------------;
//var fileNm = "js/b2link_service/list/window.b2link_service.list.setListItemDetail.js";
...
{
	window.KaiLog.timeStamp( "---- [ S ] - window.b2link_service.list.setListItemDetail():void----------" );
	...
	window.KaiLog.timeStamp( "---- [ E ] - window.b2link_service.list.setListItemDetail():void----------" );
};
