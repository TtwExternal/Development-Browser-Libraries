//----------------------------------------------------------------------------------------------------;
//var fileNm = "js/b2link_service/list/window.b2link_service.list.getListItemDetail.js";
...
{
	window.KaiLog.timeStamp( "---- [ S ] - window.b2link_service.list.getListItemDetail():void----------" );
	...
	window.KaiLog.timeStamp( "---- [ E ] - window.b2link_service.list.getListItemDetail():void----------" );
};
