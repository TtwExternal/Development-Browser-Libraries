//----------------------------------------------------------------------------------------------------;
//var fileNm = "js/b2link_service/selector/window.b2link_service.selector.getSelectorList_Range.js";
...
{
	//window.TtwLog.timeStamp( "---- [ S ] -window.b2link_service.selector.getSelectorList_Range():void----------" );
	...
	//window.TtwLog.timeStamp( "---- [ E ] - window.b2link_service.selector.getSelectorList_Range():void----------" );
};
