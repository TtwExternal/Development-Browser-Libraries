//----------------------------------------------------------------------------------------------------;
//var fileNm = "js/b2link_service/common/window.b2link_service.common._fn_req_POST__ArrayBuffer__Ref.js";
...
(function(){
	...
	{
		//window.TtwLog.timeStamp( "---- [ S ] - window.b2link_service.common._fn_req_POST__ArrayBuffer__Ref():void----------" );
		...
		//window.TtwLog.timeStamp( "---- [ E ] - window.b2link_service.common._fn_req_POST__ArrayBuffer__Ref():void----------" );
	};
})();
