//----------------------------------------------------------------------------------------------------;
//var fileNm = "js/b2link_service/common/window.b2link_service.common._fn_authRes_for_string_result__locale_label.js";
...
{
	//window.TtwLog.timeStamp( "---- [ S ] - window.b2link_service.common._fn_authRes_for_string_result__locale_label():void----------" );
	...
	//window.TtwLog.timeStamp( "---- [ E ] - window.b2link_service.common._fn_authRes_for_string_result__locale_label():void----------" );
};
